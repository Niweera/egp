<?php 
	...
	*/
	...
	if( $items == false ){ 
		$url = 'https://wow-estore.com/list-items/items.php';
		$request_args = array(
		'method'      => 'POST',
		'timeout'     => 20,
		'redirection' => 5,
...
<h3>Several items you can use on your site with the plugin WP Coder</h3>

<div class="theme-browser">
	<div class="themes">			
		<?php 
		$image = 'https://wow-estore.com/list-items/items-img/';
