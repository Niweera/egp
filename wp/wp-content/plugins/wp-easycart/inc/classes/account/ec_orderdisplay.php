	...
	public function display_order_customer_notes( ){
		...
		foreach( $order_notes as $order_note ){
			if( $order_note->order_completed_note != '' ){
				$content = apply_filters( 'the_content', stripslashes( $order_note->order_completed_note ) );
	...
	public function display_order_customer_email_notes( ){
		...
		foreach( $order_notes as $order_note ){
			if( $order_note->order_completed_email_note != '' ){
				$content = apply_filters( 'the_content', stripslashes( $order_note->order_completed_email_note ) );
				$content = str_replace( ']]>', ']]&gt;', $content );
				echo $content;
			}
		}
	...
	public function display_order_customer_details_notes( ){
		...
		foreach( $order_notes as $order_note ){
			if( $order_note->order_completed_details_note != '' ){
				$content = apply_filters( 'the_content', stripslashes( $order_note->order_completed_details_note ) );
				$content = str_replace( ']]>', ']]&gt;', $content );
				echo $content;
			}
		}
